...
使用 Windows 中文 SAPI 离线识别“你好小爱”，自动播放提示音并让 PC 版小爱同学进入聆听状态。麦克风休眠、重连、识别流结束或系统恢复/解锁后，会重启监听器并绑定新设备。无指令时，或小爱回答播放完毕后，窗口会在 1 秒后自动关闭，后台服务仍保持运行。关机、重启等电源任务不会自动关闭窗口，以免中断任务。
